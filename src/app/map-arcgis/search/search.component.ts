  ...
  res_lahanasetpemda: any;
	...
	constructor(
      ...
      petabangunan2: {
          ...
          searchFields: [ 'LOKASI', 'NAMA_BANGUNAN', 'PENGELOLA_NAMA', 'EMAIL', 'KETERANGAN' ],
          displayField: 'NAMA_BANGUNAN',
          exactMatch: false,
          outFields: [ '*' ],
          name: 'Peta Bangunan',
      ...
      panduanrancang: {
          featureLayer: {
              url: 'https://tataruang.jakarta.go.id/server/rest/services/DCKTRP/UDGL/MapServer/0/query?'
          },
      ...
      cagarbudaya: {
          ...
          searchFields: [ 'NAME', 'ALAMAT___L', 'JENIS_CAGA', 'SK_KETETAP', 'KETERANGAN' ],
          displayField: 'NAME',
          exactMatch: false,
          outFields: [ '*' ],
          name: 'Cagar Budaya',
      ...
      lahanasetpemda: {
          ...
          maxSuggestions: 6
			...
			this.searchService.searchItem(srcSearch.petabangunan1.featureLayer.url).subscribe((data: any) => {
      ...
      this.searchService.searchItem(srcSearch.petabangunan2.featureLayer.url).subscribe((data: any) => {
				function titleCase(str) {
					str = str.toLowerCase().split(' ');
					for (var i = 0; i < str.length; i++) {
						str[i] = str[i].charAt(0).toUpperCase() + str[i].slice(1);
      ...
      this.searchService.searchItem(srcSearch.batassubblok.featureLayer.url).subscribe((data: any) => {
				function titleCase(str) {
					str = str.toLowerCase().split(' ');
					for (var i = 0; i < str.length; i++) {
						str[i] = str[i].charAt(0).toUpperCase() + str[i].slice(1);
      ...
      this.searchService.searchItem(srcSearch.jalanjakarta.featureLayer.url).subscribe((data: any) => {
				function titleCase(str) {
					str = str.toLowerCase().split(' ');
					for (var i = 0; i < str.length; i++) {
						str[i] = str[i].charAt(0).toUpperCase() + str[i].slice(1);
      ...
      this.searchService.searchItem(srcSearch.stasiunKA.featureLayer.url).subscribe((data: any) => {
				function titleCase(str) {
					str = str.toLowerCase().split(' ');
					for (var i = 0; i < str.length; i++) {
						str[i] = str[i].charAt(0).toUpperCase() + str[i].slice(1);
      ...
      this.searchService.searchItem(srcSearch.kawasanrawanbanjir.featureLayer.url).subscribe((data: any) => {
				function titleCase(str) {
					str = str.toLowerCase().split(' ');
					for (var i = 0; i < str.length; i++) {
						str[i] = str[i].charAt(0).toUpperCase() + str[i].slice(1);
      ...
      this.searchService.searchItem(srcSearch.panduanrancang.featureLayer.url).subscribe((data: any) => {
				function titleCase(str) {
					str = str.toLowerCase().split(' ');
					for (var i = 0; i < str.length; i++) {
						str[i] = str[i].charAt(0).toUpperCase() + str[i].slice(1);
      ...
      this.searchService.searchItem(srcSearch.noPBB.featureLayer.url).subscribe((data: any) => {
				function titleCase(str) {
					str = str.toLowerCase().split(' ');
					for (var i = 0; i < str.length; i++) {
						str[i] = str[i].charAt(0).toUpperCase() + str[i].slice(1);
      ...
      this.searchService.searchItem(srcSearch.pusatmall.featureLayer.url).subscribe((data: any) => {
				function titleCase(str) {
					str = str.toLowerCase().split(' ');
					for (var i = 0; i < str.length; i++) {
						str[i] = str[i].charAt(0).toUpperCase() + str[i].slice(1);
      ...
      this.searchService.searchItem(srcSearch.cagarbudaya.featureLayer.url).subscribe((data: any) => {
				function titleCase(str) {
					str = str.toLowerCase().split(' ');
					for (var i = 0; i < str.length; i++) {
						str[i] = str[i].charAt(0).toUpperCase() + str[i].slice(1);
      ...
      this.searchService.searchItem(srcSearch.pasar.featureLayer.url).subscribe((data: any) => {
				function titleCase(str) {
					str = str.toLowerCase().split(' ');
					for (var i = 0; i < str.length; i++) {
						str[i] = str[i].charAt(0).toUpperCase() + str[i].slice(1);
      ...
      this.searchService.searchItem(srcSearch.ruanghijau.featureLayer.url).subscribe((data: any) => {
				function titleCase(str) {
					str = str.toLowerCase().split(' ');
					for (var i = 0; i < str.length; i++) {
						str[i] = str[i].charAt(0).toUpperCase() + str[i].slice(1);
      ...
      this.searchService.searchItem(srcSearch.bangunganasetpemda.featureLayer.url).subscribe((data: any) => {
				function titleCase(str) {
					str = str.toLowerCase().split(' ');
					for (var i = 0; i < str.length; i++) {
						str[i] = str[i].charAt(0).toUpperCase() + str[i].slice(1);
      ...
      this.searchService.searchItem(srcSearch.lahanasetpemda.featureLayer.url).subscribe((data: any) => {
				function titleCase(str) {
					str = str.toLowerCase().split(' ');
					for (var i = 0; i < str.length; i++) {
						str[i] = str[i].charAt(0).toUpperCase() + str[i].slice(1);
